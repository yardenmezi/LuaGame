...
for i=1,4 do
  ...
  frames[i] = love.graphics.newQuad(image:getWidth()/4*(i-1), 0,image:getWidth()/4,image:getHeight(), image:getDimensions())
end
local imageProperties = {img=image, sizeX=100,sizeY=150, frames=frames, fsizeX =image:getWidth()/4, fsizeY=image:getHeight()}
