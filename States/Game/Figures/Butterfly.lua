...
for i=1,3 do
  ...
  frames[i] = love.graphics.newQuad(image:getWidth()/3*(i-1),0,image:getWidth()/3,image:getHeight(), image:getDimensions())
end
local imageProperties = {img = image, sizeX=60,sizeY=60, frames=frames, fsizeX =image:getWidth()/3, fsizeY=image:getHeight()}
